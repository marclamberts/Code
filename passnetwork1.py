...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 18 00:08:03 2021
...
#read in csv
df = pd.read_csv('vvv1.csv')

df = df.loc[(df['teamId']==765)].reset_index()
...
successful = successful[(successful['minute'] >= 1) & (successful['minute']<56)]
...
pitch = pitch = VerticalPitch(pitch_type='opta', orientation='vertical',
