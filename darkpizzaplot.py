...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 29 13:01:12 2022
...
player = df.loc[df['Player']=='S.  Zadrazil'].reset_index()
...
slice_colors = ["#008000"] * 5 + ["#FF9300"] * 4     + ["#D70232"] * 3
...
# add title
fig.text(
    0.515, 0.97, "S.  Zadrazil - Bayern München\n\n", size=25,
...
fig.text(
    0.515, 0.932,
    "Per 90 Percentile Rank vs Frauen-Bundesliga CM+DM 21/22\n\n",
    size=15,
    ha="center", color="white"
)

fig.text(
    0.09, 0.005, f"Minimal 650 minutes", color="white")
...
# add text
fig.text(
    0.34, 0.935, "Defending       Creating      Progression                ", size=14,color="white"
)
...
plt.savefig('T. Hemed.png',dpi=500,bbox_inches = 'tight', facecolor='#000000')
