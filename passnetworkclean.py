...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov 27 14:14:28 2021
...
pass_nodes = pitch.scatter(1.2*average_locs_and_count.x, 80-0.8*average_locs_and_count.y, s=900,
                           color='#000000', edgecolors="#FF0000", linewidth=2, alpha=1, ax=ax, zorder=2)
...
#save the plot
plt.savefig('nec.png', dpi = 500, bbox_inches='tight',facecolor='#000000')